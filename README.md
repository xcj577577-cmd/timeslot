...
- **首页看板**：用可缩放时间轴、倒计时/番茄钟/正计时卡片、数据洞察与 7 天趋势快速了解当前节奏。
- **专注记录**：按全部、今天、按周、近 7 天、本月或自定义日期范围查看趋势与任务分布。
- **历史修正**：右键阶段记录即可修正起止时间或任务名，时长按新的墙钟时间重新计算。
- **安全备份**：导出或导入 JSON；导入前必须先成功创建当前数据的自动备份。
- **可靠升级**：本地存储迁移会先保留旧版快照，规范化成功后才标记迁移完成。
- **系统级体验**：支持通知、提示音、跟随系统/浅色/深色外观、减少动态效果与键盘快捷键。
...
下面是时隙当前版本的真实界面截图，展示首页看板、倒计时工作区与专注工作区。

<p align="center">
  <img src="./docs/images/home-overview.jpg" alt="时隙首页时间轴与数据洞察看板" width="820" />
</p>

<p align="center"><sub>首页看板：时间轴、实时计时卡片、专注洞察与 7 天趋势集中在一个工作区。</sub></p>

<table>
  <tr>
    <td align="center" width="50%">
      <img src="./docs/images/countdown-overview.jpg" alt="时隙倒计时工作区" width="520" />
      <br /><sub>倒计时工作区：目标进度、时间里程碑与小组件操作集中展示。</sub>
    </td>
    <td align="center" width="50%">
      <img src="./docs/images/pomodoro-overview.jpg" alt="时隙专注工作区" width="520" />
      <br /><sub>专注工作区：番茄钟、正计时、当前任务与阶段统计集中展示。</sub></sub>
    </td>
  </tr>
</table>
